 ...
 * resize handling.
 *
 * The starter's export toolbar has been removed: this page is a drawing to
 * read, not a model to take away, and two download buttons standing over the
 * world were two controls that had nothing to do with it.
 *
 ...
 *     // …build the model out of named meshes…
 *     stage.setObject(model);
 *   </script>
 *
 * Attributes:
 *   name       — a label for the scene (default "model")
